...
for config in config_sample:
    filename = os.path.join(path, config)+'/coords.csv_sparse_graph.npz_interchr.npz_tsvd.npz'
    print(filename)
...
fileName = '/media/garner1/hdd1/gpseq' + '/info_10000' + '/nnparafac_WOintraChrom' + '_rank' + str(rank) + '_sample' + str(ind) + '_size' + str(samples) + '.pkl'
...
fileName = '/media/garner1/hdd1/gpseq' + '/info_10000' + '/cf-sampled_WOintraChrom' + '_rank' + str(rank) + '_sample' + str(ind) + '_size' + str(samples) + '.pkl'
fileObject = open(fileName, 'wb')
if save:
