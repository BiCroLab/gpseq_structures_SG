...
fileName = '/media/garner1/hdd1/gpseq' + '/info_10000G' + '/nnparafac_no-svd' + '_comm' + str(comm) + '_sample' + str(ind) + '_size' + str(samples) + '.pkl'
...
fileName = '/media/garner1/hdd1/gpseq' + '/info_10000G' + '/cf-sampled_no-svd' + '_comm' + str(comm) + '_sample' + str(ind) + '_size' + str(samples) + '.pkl'
fileObject = open(fileName, 'wb')
if save:
